...
public interface InteractionRepository extends JpaRepository<Interaction, Long> {
    ...
    @Query("SELECT i.articleCategory as category, " + "SUM(CASE WHEN i.interactionType = 'SAVE' THEN 3 " + "         WHEN i.interactionType = 'SUMMARIZE' THEN 2 " + "         ELSE 1 END) as points, " + // Puntos para el algoritmo
